function perguntaResposta(reposta){
   ...
   var contador = 0
    while(contador < 5){
   repostaFinal = prompt('Faça sua escolha: \n 1 - Diga "olá, posso ajudar em alguma coisa?" \n 2- Encoste no rapaz para chamar a atenção.')
        if(repostaFinal === '1'){
            return `
            ...
            <h2>Ele parece querer atacá-lo, então você dá 3 passos para trás e encontra em cima da mesa uma faca.</h2>
            <br>
